...
powershell -NoProfile -ExecutionPolicy Bypass -Command "[Net.ServicePointManager]::SecurityProtocol=[Net.SecurityProtocolType]::Tls12; $d=Join-Path $env:TEMP 'coding-agent-go'; Invoke-WebRequest 'https://cdn.jsdelivr.net/gh/hhwyt/coding-agent-go@main/server.py' -OutFile (Join-Path $d 'server.py') -UseBasicParsing; Invoke-WebRequest 'https://cdn.jsdelivr.net/gh/hhwyt/coding-agent-go@main/providers.json' -OutFile (Join-Path $d 'providers.json') -UseBasicParsing"
exit /b
