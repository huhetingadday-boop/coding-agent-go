...
## Windows security software blocking the install
360 / 电脑管家 / Windows SmartScreen sometimes block the PowerShell script or the background proxy. If that happens:
